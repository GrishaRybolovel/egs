...
urlpatterns = [
     ...
     path('employees/edit/document/<int:id_doc>/<int:id_emp>', document_edit_employee, name='document_edit_employee'),
     path('employees/edit/document/delete/<int:id_doc>/<int:id_emp>', document_del_employee, name='document_del_employee'),
